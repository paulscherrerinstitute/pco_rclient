...
"""
POC Camera writer test script #1

Description:
Instantiates a PcoWriter object, configures, and quits on the wait method, halting execution before receiving all the frames.
